...
indiaAttack<-terror %>%
  filter(country_txt=="India") %>% select(provstate,city,summary,location,success,attacktype1_txt,targtype1_txt,gname,weaptype1_txt,nkill) 
...
ggplot(aes(x=reorder(state,successful),y=successful ),data = indiastate) + geom_col(color="black",fill="blue") + 
  coord_flip() + 
